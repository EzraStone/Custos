"""VPC Flow Logs version 5 records, and the ALB access log lines beside them.

Field names and ordering match the AWS log format string in `LOG_FORMAT`, so
fixtures generated here are byte-comparable with what CloudWatch Logs delivers.
"""
